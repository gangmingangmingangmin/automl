  ...
  def run_model(self, runmode, **kwargs):
    ...
    if runmode == 'dry':
      ...
      if runmode == 'saved_model':
        ...
        #여기 수정 inference model return
        return self.saved_model_inference(kwargs['input_image'],
                                   kwargs['output_image_dir'], **config_dict)
